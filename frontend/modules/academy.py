...
def show_academy():
    ...
    quizzes = [
        {
            "sender": "김철수 대리",
            "case": "주형님! 저 급하게 결제할 게 있는데 폰이 고장나서요. 50만원만 먼저 보내주시면 저녁에 바로 드릴게요.",
            "is_phishing": True,
            "exp": "지인 사칭 금전 요구는 반드시 전화를 통해 본인 확인을 해야 합니다.",
        },
        {
            "sender": "우체국 알림톡",
            "case": "[우체국] 주소지 불분명으로 배송 보류. 확인 바랍니다: http://k-post.net/check",
            "is_phishing": True,
            "exp": "공식 기관은 생소한 도메인(.net 등)을 통한 URL 접속을 유도하지 않습니다.",
        },
        {
            "sender": "국민건강보험",
            "case": "2026년 건강검진 대상자입니다. 상세 내용은 공식 앱 'The건강보험'에서 안전하게 확인하세요.",
            "is_phishing": False,
            "exp": "링크 없이 공식 앱 사용을 권장하는 메시지는 안전합니다.",
        },
        {
            "sender": "OO은행 장팀장",
            "case": "(광고) 주형 님만을 위한 특별 저금리 대환 대출. 연 2.1% 즉시 승인 가능합니다.",
            "is_phishing": True,
            "exp": "금융기관은 모바일 메시지로 먼저 대출 상담을 제안하지 않습니다.",
        },
    ]
